...
class Rocblas(CMakePackage):
    ...
    url = "https://github.com/ROCm/rocBLAS/archive/rocm-6.0.2.tar.gz"
    tags = ["rocm"]
    ...
    depends_on("hip@4.1.0:6.0", when="@4.1.0:6.0")
    depends_on("llvm-amdgpu@4.1.0:6.0", type="build", when="@4.1.0:6.0")
    depends_on("rocm-cmake@master", type="build", when="@master")
    depends_on("rocm-cmake@4.5.0:6.0", type="build", when="@4.5.0:6.0")
    depends_on("rocm-cmake@4.3.0:6.0", type="build", when="@4.3.0:6.0")
    depends_on("rocm-cmake@3.5.0:6.0", type="build", when="@3.5.0:6.0")
