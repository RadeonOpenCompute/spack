...
class Hipblas(CMakePackage, CudaPackage, ROCmPackage):
    ...
    depends_on("rocm-cmake@5.2.0:5.7", type="build", when="@5.2.0:5.7")
    depends_on("rocm-cmake@4.5.0:5.1", type="build", when="@4.5.0:5.1")
    depends_on("rocm-cmake@3.5.0:4.4", type="build", when="@3.5.0:4.4")
