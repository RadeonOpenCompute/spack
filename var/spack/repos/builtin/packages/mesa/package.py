...
class Mesa(MesonPackage):
    ...
    version("23.0.1", sha256="e8e586856b55893abae9bdcdb98b41c081d909bb1faf372e6e7262307bf34adf",
        preferred=True,
    )
    ...
    patch("handle_missing_set_override_stack_alignment.patch", when="@21.2.3:22.2.5")
    ...
    patch("0001-disable-gallivm-coroutine-for-libllvm15.patch", when="@22.1.2:22.2.5 ^libllvm@15")
